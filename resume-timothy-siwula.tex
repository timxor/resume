...
%-------------------------------------------
  ...
  \href{mailto:perfectcodeismenycresume@gmail.com}{Email : perfectcodeismenycresume@gmail.com} \\
\end{tabular*}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Dockerized}
          {Worked between teams to port legacy test framework to from protractor to cypress within docker.}

        \resumeItem{ETL}
          {Updated data pipeline to support new column for enhanced reporting capability. }
...
%    %-----------Siwula Software LLC-----------------
%    \resumeSubheading
%      {Siwula Software, LLC}{Chicago, IL}
