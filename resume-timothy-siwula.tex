...
%-------------------------------------------
  ...
  \href{mailto:siwulasoftware@gmail.com}{Email : siwulasoftware@gmail.com} \\
\end{tabular*}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    %-----------Ensighten-----------------
    \resumeSubheading
      {Ensighten}{Chicago, IL}
      {Software Engineer}{Jun 2019 - Present}
      \resumeItemListStart
        \resumeItem{DevOps}
          {Migrating one test framework to another. Docker, Bamboo, Nodejs, Angular, Spring/Java.}
      \resumeItemListEnd
