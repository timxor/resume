...
%-------------------------------------------
  ...
  %----------- LINKEDIN MIDDLE LEFT SIDE -----------------       ----------- CITY MIDDLE RIGHT SIDE -----------------
  \href{https://linkedin.com/in/siwulactim/}{linkedin.com/in/siwulactim} & \href{}{Chicago, Illinois} \\
  
  

  %----------- CITY BOTTOM LEFT SIDE -----------------          ----------- LINKEDIN BOTTOM RIGHT SIDE -----------------
  \href{}{Chicago, IL} & \href{https://linkedin.com/in/siwulactim/}{linkedin.com/in/siwulactim} \\
...
%----
    ...
    \resumeSubheading
      ...
      {Software Engineer}{Oct 2022 - Jul 2023}
      \resumeItemListStart
...
%----
    ...
    \section{Technical Skills}
      \resumeSubHeadingListStart
        ...
        \item{
          %--------TECHNOLOGIES------------
          \textbf{Technologies}{: Linux, AWS/GCP, Docker, Hadoop, PostgreSQL, Git, Terraform, Node.js, TensorFlow }
        }
