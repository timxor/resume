...
%-------------------------------------------
  ...
  \color{blue}\href{}{http://www.timsiwula.com} & {+1 (917) 885-3119} \\
  \color{blue}\href{}{https://github.com/timxor/} & \color{blue}{tim@acceptance.ai} \\
  \color{blue}\href{}{https://linkedin.com/in/timsiwula/} & {Greater Chicagoland} \\
\end{tabular*}
  ...
  \resumeSubheading
    ...
    \resumeItemListStart
      \resumeItem{Government Procurement}
        {Preparing to submit proposals to various BAA/SBIR contracts across a few organizations such as DARPA, DOE, NSF, Navy and Air Force.}
        {Writing letter of intents and memorandum of understanding.}
      \resumeItemListEnd
    ...
    \section{Leadership Activities}
      ...
      % ussocom - sme
       \resumeSubItem{2020 - Subject Matter Expert}
          {Innovation Foundry Artificial Intelligence for Maneuver, Intelligence, and Effects, United States Special Operations Command (USSOCOM)}
